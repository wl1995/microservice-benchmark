...
echo "TUM launched Rviz: $(date +"%T.%N")"

ros2 launch autoware_launch rviz.launch.xml vehicle_model:=sample_vehicle sensor_model:=sample_sensor_kit vehicle_id:=1 map_path:=$HOME/autoware_map/sample-map-rosbag
